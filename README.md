...
Directory [`auto/`](https://github.com/vvilimek/iana-yang-sids/tree/master/auto) has `Makefile` and generated .sid files for all tracked modules.
See the `Makefile` for how the .sid files are genereted.

Directory [`optimal/`](https://github.com/vvilimek/iana-yang-sids/tree/master/optimal) contains optimized .sid files after the analysis. If the .sid file is missing
there, it has not been (most likely) analyzed yet.

In the [`misc/`](https://github.com/vvilimek/iana-yang-sids/tree/master/misc) directory, you can find modules not tracked by referenced IANA registry
...
# Tracked modules
 ...
 | [ietf-interfaces](ietf-interfaces.yang)           | 2018-02-20 | 1500 | 100 | `N/A` | [ietf-interfaces.sid](auto/ietf-interfaces.sid)           | `N/A` | [RFC8343](https://datatracker.ietf.org/doc/html/rfc8343) [YangModels/Yang/ietf-inetfaces.yang](https://github.com/YangModels/yang/blob/main/standard/ietf/RFC/ietf-interfaces%402018-02-20.yang) |
 ...
 | [iana-if-type](iana-if-type.yang)                 | 2014-05-08 | 1800 | 400 | `N/A` | [iana-if-type.sid](auto/iana-if-type.sid)                 | `N/A` | [RFC7224](https://datatracker.ietf.org/doc/html/rfc7224) [YangModels/Yang/iana-if-type.yang](https://github.com/YangModels/yang/blob/main/standard/ietf/RFC/iana-if-type%402014-05-08.yang) |
